...
export const doctorService = {
  ...
  async approveAppointment(appointmentId, notes = '') {
    try {
      const response = await api.put(`/doctor/appointments/${appointmentId}/approve`, { notes });
      return { success: true, data: response.data };
    } catch (error) {
      return {
        success: false,
  ...
  async rejectAppointment(appointmentId, notes = '') {
    try {
      const response = await api.put(`/doctor/appointments/${appointmentId}/reject`, { notes });
      return { success: true, data: response.data };
    } catch (error) {
      return {
        success: false,
  ...
  async completeAppointment(appointmentId, notes = '') {
    try {
      const response = await api.put(`/doctor/appointments/${appointmentId}/complete`, { notes });
      return { success: true, data: response.data };
    } catch (error) {
      return {
        success: false,
